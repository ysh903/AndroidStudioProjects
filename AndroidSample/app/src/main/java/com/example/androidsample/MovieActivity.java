...
class SearchTitleRunnable2 implements Runnable{
    private String keyword;
    private Handler handler;

    SearchTitleRunnable2(Handler handler, String keyword){
...
public class MovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button searchBtn = (Button) findViewById(R.id.searchDateBtn);
        final EditText keywordEt2 = (EditText) findViewById(R.id.keywordEt2);
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SearchTitleRunnable runnable =
                        new SearchTitleRunnable(handler, keywordEt2.getText().toString());
